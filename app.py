...
from PyQt6.QtWidgets import (QApplication, QWidget, QLabel, QLineEdit, QPushButton, QSlider,
                             QTabWidget, QTextEdit, QComboBox, QToolButton, QStatusBar,
...
class GrammarChecker(QWidget):
    ...
    def init_configure_signals(self):
        ...
        self.temperature.valueChanged.connect(lambda: self.temperature_value.setText('{0: .2f}'.format(self.temperature_value())))
    ...
    def submit(self):
        ...
        prompt = 'Check the grammar for below sentence \n{0}'.format(text_block.strip())
...
class AppWindow(QWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon('chatgpt_icon.png'))
    ...
    def add_tab(self):
        ...
        self.tab_manager.addTab(GrammarChecker(), 'Grammar Check #{0}'.format(tab_count))
...
if __name__ == "__main__":
    config = ConfigParser()
    config.read('password_manager.ini.txt')
